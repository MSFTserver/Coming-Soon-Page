...
$conf['db_username'] = 'admin'; // MySQL username
$conf['db_password'] = 'password'; // MySQL password
$conf['db_name'] = 'coming-soon'; // MySQL database name
...
$conf['logo_alt_text'] = 'Coming Soon Logo';


// Colours
$conf['colour_background'] = '#000000';
$conf['colour_block_background'] = '#036149';
...
$conf['colour_icons'] = '#036149';
$conf['colour_submit'] = '#078707';
$conf['colour_hover'] = '#078707';


// Website name
$conf['website_name'] = 'Coming Soon Page'; // Name of the Website as it appear on page and emails
...
$conf['progressbar_percent'] = 30; // Percentage of the prgress bar
...
// Social networks
$conf['facebook'] = 'https://www.facebook.com/'; // Remove or leave empty if not used
$conf['twitter'] = 'https://twitter.com/'; // Remove or leave empty if not used
$conf['github'] = 'https://github.com/'; // Remove or leave empty if not used
$conf['linkedin'] = 'https://www.linkedin.com/in/'; // Remove or leave empty if not used
...
$conf['email_address'] = 'admin@localhost'; // Email address sending all the emails messages
$conf['email_from_name'] = 'My Website Name'; // Email from


// About
$conf['about_activated'] = TRUE; // Show or hide the about page with TRUE or FALSE
// Donation Addresses
$conf['donation_activated'] = TRUE; // Display Donation Addresses on About/Info popup
...
$conf['admin_password'] = 'password'; // Administrator password
$conf['admin_cookie'] = 'Admin Cookie'; // Administrator cookie identification
